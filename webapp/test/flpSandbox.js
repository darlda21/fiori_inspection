		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "재고검수",
									"targetURL": "#syncbiginspection1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncbiginspection1-display": {
								"semanticObject": "syncbiginspection1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=syncbiginspection1",
									"url": sap.ui.require.toUrl("syncbiginspection1")
								}
							}
						}
					}
